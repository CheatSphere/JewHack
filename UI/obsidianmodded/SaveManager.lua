...
local SaveManager = {} do
    ...
    function SaveManager:Save(name)
        ...
        local IsAutoSave = (name == "AutoSave")
        ...
        for idx, toggle in pairs(self.Library.Toggles) do
            ...
            local SValue = toggle.Value
            if IsAutoSave then
                for _, addon in pairs(toggle.Addons or {}) do
            ...
            table.insert(data.objects, { type = "Toggle", idx = idx, value = SValue })
        end
    ...
    function SaveManager:BuildConfigSection(tab)
        ...
        section:AddButton("Create Config", function()
            ...
            if name == "AutoSave" then
                self.Library:Notify('Cannot use name "AutoSave"', 2)
                return
            end
        ...
        deleteconfigbutton:AddButton("Refresh List", function()
            self.Library.Options.SaveManager_ConfigList:SetValues(self:RefreshConfigList())
            self.Library.Options.SaveManager_ConfigList:SetValue(nil)
        end)
        ...
        autoloadbutton:AddButton("Reset Autoload", function()
