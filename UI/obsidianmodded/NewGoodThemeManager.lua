...
do
    ...
    ThemeManager.BuiltInThemes = {
        ["Default"] = {
            1,
            { FontColor = "ffffff", MainColor = "141414", AccentColor = "ff4672", BackgroundColor = "0a0a0a", OutlineColor = "212121" }, --AccentColor = "7c8db8",
        },
        ["ReDefault"] = {
            2,
    ...
    function ThemeManager:CreateThemeManager(groupbox)
        ...
        local deletethemebutton = groupbox:AddButton("Delete Theme", function()
            pcall(function()
                local name = self.Library.Options.ThemeManager_CustomThemeList.Value
        ...
        deletethemebutton:AddButton("Refresh List", function()
            self.Library.Options.ThemeManager_CustomThemeList:SetValues(self:ReloadCustomThemes())
            self.Library.Options.ThemeManager_CustomThemeList:SetValue(nil)
        end)
        local setasdefaultbutton = groupbox:AddButton("Set as Default", function()
            pcall(function()
                if
        ...
        setasdefaultbutton:AddButton("Reset Default", function()
